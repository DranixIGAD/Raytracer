...
public:
	...
	//Matrix44(const Vector3& from, const Vector3& to) : x4(from.x), y4(from.y), z4(from.z),
	//												   a1(0), a2(0), a3(0), a4(1)
	Matrix44(const Vector3& from, const Vector3& to) : x4(0), y4(0), z4(0),
													   a1(0), a2(0), a3(0), a4(1)
												   
	//Matrix44(const Vector3& from, const Vector3& to) : a1(0), a2(0), a3(0), a4(1),
	//												   x4(from.x), y4(from.y), z4(from.z)
	{
		//Vector3 forward = to - from;	// working for me (I think)
		Vector3 forward = from - to;	// guide scratch/openGL
		...
		//Vector3 forward = to - from;	// guide scratch/openGL
		//forward.z *= -1;
		//forward.Normalize();
		////
		//Vector3 temp(0, 1, 0);
		...
		//up.Normalize();
		////
		//Matrix44 lookAt(right.x,		right.y,		right.z,		0,
		//				up.x,			up.y,			up.z,			0,
		//				forward.x,	forward.y,	forward.z,	0,
		//				0,			0,			0,			1);
		////
		//Matrix44 translation;
		//translation.makeTranslation(from.x, from.y, from.z);
		////
		//Matrix44 Iam = lookAt * translation;
		////
		//x1 = Iam.x1;	x2 = Iam.x2;	x3 = Iam.x3;	x4 = Iam.x4;
		//y1 = Iam.y1;	y2 = Iam.y2;	y3 = Iam.y3;	y4 = Iam.y4;
		//z1 = Iam.z1;	z2 = Iam.z2;	z3 = Iam.z3;	z4 = Iam.z4;
		//a1 = Iam.a1;	a2 = Iam.a2;	a3 = Iam.a3;	a4 = Iam.a4;
